package com.mehdi.springboot3jwt.auth;

import com.fasterxml.jackson.databind.ObjectMapper;
import com.mehdi.springboot3jwt.config.JwtService;
import com.mehdi.springboot3jwt.entity.Role;
import com.mehdi.springboot3jwt.entity.UserEntity;
import com.mehdi.springboot3jwt.repository.UserRepository;
...
public class AuthenticationService {
    ...
    public AuthenticationResponse registerAdmin(RegisterRequest request) {
        Role role = Role.ADMIN; // تعيين الدور الافتراضي للمستخدم العادي
    ...
    public AuthenticationResponse registerManager(RegisterRequest request) {
        Role role = Role.MANAGER; // تعيين الدور الافتراضي للمستخدم العادي
